...
tags: politics economics education investments oil qe
sharing: true
...
So far, the governments were slow to react, which is weird as a big part of politicians falls into the danger zone. The average politician is [53 years old](https://archive.ipu.org/gpr-e/media/index.htm), while the average human is [under 30](https://ourworldindata.org/age-structure). Stats aside, almost every major country had introduced at least some form of quarantine, and I am pretty sure it will work! That's old news, let's see what's next!
...
If the money leaves the stock market it must go somewhere else within the [financial ecosystem](https://money.visualcapitalist.com/worlds-money-markets-one-visualization-2017/), but most assets were loosing value in the past month.
...
- Constructing 700 hospitals with 350'000 beds. [Source](https://cost-finder.com/how-much-does-it-cost-to-build-a-hospital/).
...
- Industrial complexes could be moved to sparsely populated regions, as some [diseases like non-Hodgkin's lymphoma are 10 times more likely near factories. Even in developed countries like the US.](https://www.euro.who.int/__data/assets/pdf_file/0006/264813/Human-Health-in-Areas-with-Industrial-Contamination-Eng.pdf)
